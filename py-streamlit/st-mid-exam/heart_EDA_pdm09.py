...
st.sidebar.subheader('Visualization using seaborn and plotly by pdm09')
...
with row1_1: 
    box_x = st.selectbox("Boxplot variable", options=df.columns, index=df.columns.get_loc("chol"))
